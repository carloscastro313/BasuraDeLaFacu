...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            if(form.DialogResult==DialogResult.OK&&form.GetProductoModificado!=null)
            {
                this.productoSeleccionado = form.GetProductoModificado;
            }
            form.ShowDialog();
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
               if(comiqueria!=form.GetProducto)
               {
                    comiqueria.Productos.Add(form.GetProducto);
               }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if(comiqueria==(Producto)this.listBoxProductos.SelectedItem)
                    {
                        comiqueria.Productos.Remove((Producto)this.listBoxProductos.SelectedItem);
                    }
                }
            }
            catch (Exception ex)
