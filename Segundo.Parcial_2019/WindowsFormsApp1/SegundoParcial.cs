...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        private static bool AgregarFrutas(SegundoParcial frm)
        {
            ...
            SqlConnection conexion;
            SqlCommand comando;
            List<Fruta> aux = new List<Fruta>();
            Random random = new Random();

            aux.Add(frm._banana);
            aux.Add(frm._durazno);
            aux.Add(frm._manzana);
            ...
            try
            {
                ...
                comando.CommandText += string.Format("INSERT INTO frutas (nombre,peso,precio) VALUES(@F1,@F2,@F3) ");
                ...
                foreach (Fruta item in aux)
                {
                    ...
                    comando.Parameters[1].Value = item.Peso;
                    comando.Parameters[2].Value = random.Next(100);
