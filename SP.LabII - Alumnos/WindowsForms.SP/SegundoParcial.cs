...
namespace WindowsForms.SP
{
    public partial class SegundoParcial : Form
    {
        ...
        private void btnPunto4_Click(object sender, EventArgs e)
        {
            ...
            this.c_gomas.precioMayor +=  this.c_gomas_EventoPrecio;
            this.c_gomas += new Goma(false, "Faber-Castell", 31);
        }

        private void c_gomas_EventoPrecio(object sender, EventArgs e)
        {
            bool todoOK = ImprimirTicket.precioSuperado(((Cartuchera<Goma>)sender).PrecioTotal);//Reemplazar por la llamada al método de clase ImprimirTicket
        ...
        private void btnVerLog_Click(object sender, EventArgs e)
        {
            ...
            DialogResult rta = fileDialog.ShowDialog();//Reemplazar por la llamada al método correspondiente del OpenFileDialog
        ...
        private void btnPunto6_Click(object sender, EventArgs e)
        {
            ...
            this.cn.Open();
            this.da = new SqlDataAdapter("select * from utiles",cn);
        ...
        private void btnPunto7_Click(object sender, EventArgs e)
        {
            ...
            this.da.InsertCommand= new SqlCommand("insert into utiles values(@p1, @p2, @p3)",cn);
            this.da.InsertCommand.Parameters.Add("@p1", SqlDbType.VarChar, 50, "marca");
            this.da.InsertCommand.Parameters.Add("@p2", SqlDbType.Float, 50, "precio");
            this.da.InsertCommand.Parameters.Add("@p3", SqlDbType.VarChar, 50, "tipo");
            /*this.cn.Open();
            this.da.InsertCommand.Parameters[0].Value = this.lapiz.marca;
            this.da.InsertCommand.Parameters[1].Value = this.lapiz.precio;
            this.da.InsertCommand.Parameters[2].Value = "lapiz";
            this.da.InsertCommand.ExecuteNonQuery();
            this.da.InsertCommand.Parameters[0].Value = this.goma.marca;
            this.da.InsertCommand.Parameters[1].Value = this.goma.precio;
            this.da.InsertCommand.Parameters[2].Value = "goma";
            this.da.InsertCommand.ExecuteNonQuery();
            this.da.InsertCommand.Parameters[0].Value = this.sacapunta.marca;
            this.da.InsertCommand.Parameters[1].Value = this.sacapunta.precio;
            this.da.InsertCommand.Parameters[2].Value = "sacapunta";
            this.da.InsertCommand.ExecuteNonQuery();
            this.cn.Close();*/
            //Agregar los utiles del formulario al dataTable
            DataRow row = this.dt.NewRow();
            row["marca"] = this.lapiz.marca;
            row["precio"] = this.lapiz.precio;
            row["tipo"] = "Lapiz";
            this.dt.Rows.Add(row);
            DataRow row2 = this.dt.NewRow();
            row2["marca"] = this.goma.marca;
            row2["precio"] = this.goma.precio;
            row2["tipo"] = "goma";
            this.dt.Rows.Add(row2);
            DataRow row3 = this.dt.NewRow();
            row3["marca"] = this.sacapunta.marca;
            row3["precio"] = this.sacapunta.precio;
            row3["tipo"] = "sacapunta";
        ...
        private void btnPunto8_Click(object sender, EventArgs e)
        {
            ...
            this.da.DeleteCommand = new SqlCommand("delete from utiles where id = @p1", cn);
        ...
        private void btnPunto9_Click(object sender, EventArgs e)
        {
            ...
            this.da.UpdateCommand = new SqlCommand("update utiles set marca = @p1, precio = @p2 where id = @p3", cn);
            this.da.UpdateCommand.Parameters.Add("@p1", SqlDbType.VarChar, 50, "marca");
            this.da.UpdateCommand.Parameters.Add("@p2", SqlDbType.Float, 50, "precio");
            this.da.UpdateCommand.Parameters.Add("@p3", SqlDbType.Int, 50, "id");
            //Modificar el ultimo registro del dataTable
            this.dt.Rows[1]["marca"] = "barrillito";
            this.dt.Rows[1]["precio"] = 72;
        }
        ...
        private void btnPunto10_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlBulkCopy.DestinationTableName = "utiles";
                this.cn.Open();
                for (int i = 0; i < this.dt.Columns.Count; i++)
                {
                    if(this.dt.Rows[i].Table!=null)
                    {
                        sqlBulkCopy.WriteToServer(this.dt.Rows[i].Table);
                    }
